...
func TestFakeVpxencHelper(t *testing.T) {
	...
	if vp9 && os.Getenv("GOVPX_LIBVPX_VP9_CALL_STATS") != "" {
		fields := []string{
			...
			"varpart_force_split_16_variance=44",
			"varpart_force_split_16_minmax=45",
			"varpart_threshold2_count=46",
			"varpart_threshold2_sum=47",
			"varpart_var16_samples=48",
			"varpart_var16_sum=49",
			"varpart_force16_variance_sum=50",
			"varpart_force16_threshold_sum=51",
			"varpart_setvt_calls=52",
			"varpart_setvt_64x64=53",
			"varpart_setvt_32x32=54",
			"varpart_setvt_16x16=55",
			"varpart_setvt_8x8=56",
			"varpart_setvt_force_split=57",
			"varpart_setvt_force_split_64x64=58",
			"varpart_setvt_force_split_32x32=59",
			"varpart_setvt_force_split_16x16=60",
			"varpart_setvt_select=61",
			"varpart_setvt_split=62",
		}
