...
// TestLibvpxRDConstantsByteExactSweep pins the (rdmult, rddiv) pair libvpx
// computes in vp8/encoder/rdopt.c vp8_initialize_rd_consts (lines 163-225,
...
func TestLibvpxRDConstantsByteExactSweep(t *testing.T) {
	...
	libvpxRD := [vp8common.QIndexRange][2]int{
