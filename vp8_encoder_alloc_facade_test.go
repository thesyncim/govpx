...
func TestVP8EncoderPublicHotPathAllocatesZero(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "SetPreviewPostProcess", fn: func() { _ = e.SetPreviewPostProcess(govpx.PostProcessDeblock, 0) }},
		{name: "SetPreviewPostProcessConfig", fn: func() { _ = e.SetPreviewPostProcessConfig(govpx.PostProcessDeblock, 4, 0) }},
		{name: "PreviewFrame before encode", fn: func() { _, _ = e.PreviewFrame() }},
