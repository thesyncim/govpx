...
// TestVP8Task292ChromaSubpelPredictorParity pins task #292's negative
...
//     pin).
//   - vp8_byte0_kf_1280x720_ssim_good_arnr_audit_test.go (GoodQuality
//     pin).
func TestVP8Task292ChromaSubpelPredictorParity(t *testing.T) {
