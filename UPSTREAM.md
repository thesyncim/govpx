...
- `EncodeInto` can emit source-dependent DCPred keyframes and LAST/ZEROMV
  interframes with residual coding against the reconstructed last reference, but
  full prediction mode analysis, motion search, and rate-control feedback are
  not complete yet.
