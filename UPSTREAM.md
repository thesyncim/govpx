...
| IVF/test vectors | IVF parser and oracle checksum parser scaffolded; normal-test VP8/IVF smoke vectors, including NEWMV, intra-mode keyframe, and intra-macroblock interframe coverage, checksummed against libvpx v1.16.0 |
...
| Scalar DSP | clip/copy/reconstruction, SAD, variance/SSE, bilinear/six-tap subpixel, dequant, IDCT4x4, IWHT4x4, and intra predictors scaffolded |
...
- `EncodeInto` can emit source-dependent whole-block intra keyframes, LAST/ZEROMV
  residual interframes, whole-block intra macroblocks inside interframes, and
