...
| Token and mode parsing | tree reader, coefficient/mode probability state, macroblock coefficient token traversal, and keyframe macroblock mode grid scaffolded |
