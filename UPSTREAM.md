...
| Decoder state and reconstruction | state headers, macroblock residual transform, residual pixel add, intra predictor reference setup, whole-block intra prediction/reconstruction, and B_PRED 4x4 prediction/reconstruction scaffolded |
