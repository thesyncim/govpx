...
| Token and mode parsing | tree reader, partition layout, coefficient/mode probability state, macroblock coefficient token traversal, keyframe macroblock mode grid, inter macroblock mode parsing except split-MV, near-MV selection, and motion-vector decoding scaffolded |
