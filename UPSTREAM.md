...
| Encoder frame algorithms | neutral keyframe packet, keyframe mode, zero-coefficient token writers, forward transforms, and fast block quantization scaffolded |
