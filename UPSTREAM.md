...
| Oracle harness | `make verify-production` builds pinned libvpx helpers, including vpxenc, vpxdec, and the VP8 temporal SVC example encoder, fetches required corpora, and runs the full oracle gate; optional vpxdec smoke and libvpx checksum oracle scaffolded, including postprocess, ADDNOISE, and error-concealment decode modes for targeted parity tests |
