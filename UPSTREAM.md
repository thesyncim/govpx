...
| Encoder frame algorithms | neutral keyframe packet, keyframe mode, zero/nonzero coefficient token writers, forward transforms, and fast block quantization scaffolded |
