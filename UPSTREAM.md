...
| Decoder state and reconstruction | state headers, macroblock residual transform, residual pixel add, and whole-block intra prediction scaffolded; B_PRED integration not started |
