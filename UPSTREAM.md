...
| Token and mode parsing | tree reader, coefficient/mode probability state, macroblock coefficient token traversal, keyframe macroblock mode grid, inter intra mode parsing, and motion-vector decoding scaffolded |
