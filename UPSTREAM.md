...
| Token and mode parsing | tree reader, partition layout, coefficient/mode probability state, macroblock coefficient token traversal, keyframe macroblock mode grid, inter reference/intra/prediction mode parsing, near-MV selection, and motion-vector decoding scaffolded |
