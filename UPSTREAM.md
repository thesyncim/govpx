...
- `Decode` and `DecodeInto` can expose narrow profile-0 keyframe and supported
  inter-frame scaffolds, but split-MV, border-clamped subpixel prediction, and
  many VP8 features still return `ErrUnsupportedFeature`.
