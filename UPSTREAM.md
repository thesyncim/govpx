...
| Decoder state and reconstruction | state headers, macroblock residual transform, residual pixel add, whole-block intra prediction, and B_PRED 4x4 prediction scaffolded |
