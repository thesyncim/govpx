...
| Token and mode parsing | tree reader, partition layout, coefficient/mode probability state, macroblock coefficient token traversal, keyframe/inter macroblock mode grids except split-MV, near-MV selection, and motion-vector decoding scaffolded |
