...
| IVF/test vectors | IVF parser and oracle checksum parser scaffolded; normal-test VP8/IVF smoke vector checksummed against libvpx v1.16.0 |
...
- `EncodeInto` can emit source-dependent DCPred keyframes, LAST/ZEROMV
  ...
  filtering, but full prediction mode analysis, broader motion search, and
