...
//
// Root VP9 partition selection uses NNPredict through
// vp9MLPredictVarPartitioning for the ML_BASED_PARTITION speed-feature gate
// (libvpx vp9/encoder/vp9_speed_features.c:751-826).

// NNMaxHiddenLayers mirrors NN_MAX_HIDDEN_LAYERS
// (vp9/encoder/vp9_partition_models.h:18).
const NNMaxHiddenLayers = 10

// NNMaxNodesPerLayer mirrors NN_MAX_NODES_PER_LAYER
// (vp9/encoder/vp9_partition_models.h:19).
const NNMaxNodesPerLayer = 128

// NNFeatures mirrors libvpx's FEATURES macro in ml_predict_var_partitioning
// (vp9/encoder/vp9_encodeframe.c:4528).
const NNFeatures = 6

// NNLabels mirrors libvpx's LABELS macro in ml_predict_var_partitioning
// (vp9/encoder/vp9_encodeframe.c:4529).
const NNLabels = 1

// NNConfig mirrors the NN_CONFIG struct
...
type NNConfig struct {
	...
	NumOutputs      int
	NumHiddenLayers int
	NumHiddenNodes  [NNMaxHiddenLayers]int
	Weights         [NNMaxHiddenLayers + 1][]float32
	Bias            [NNMaxHiddenLayers + 1][]float32
}

// vp9_var_part_nn_weights_64_layer0 (libvpx
// vp9/encoder/vp9_partition_models.h:611-620). FEATURES=6, hidden=8.
var VarPartNNWeights64Layer0 = [6 * 8]float32{
...
var VarPartNNBias64Layer0 = [8]float32{
...
var VarPartNNWeights64Layer1 = [8]float32{
...
var VarPartNNBias32Layer0 = [8]float32{
...
var VarPartNNWeights32Layer1 = [8]float32{
...
var VarPartNNBias16Layer0 = [8]float32{
...
var VarPartNNWeights16Layer1 = [8]float32{
...
var VarPartNNBias16Layer1 = [1]float32{
	-1.95769405,
}

// VarPartNNConfig64 mirrors vp9_var_part_nnconfig_64 (libvpx
// vp9/encoder/vp9_partition_models.h:636-651). FEATURES=6.
var VarPartNNConfig64 = func() NNConfig {
	c := NNConfig{
		NumInputs:       6,
		NumOutputs:      1,
		NumHiddenLayers: 1,
	...
	c.Weights[0] = VarPartNNWeights64Layer0[:]
	c.Weights[1] = VarPartNNWeights64Layer1[:]
	c.Bias[0] = VarPartNNBias64Layer0[:]
	c.Bias[1] = VarPartNNBias64Layer1[:]
	return c
}()

// VarPartNNConfig32 mirrors vp9_var_part_nnconfig_32 (libvpx
// vp9/encoder/vp9_partition_models.h:678-693). FEATURES=6.
var VarPartNNConfig32 = func() NNConfig {
	c := NNConfig{
		NumInputs:       6,
		NumOutputs:      1,
		NumHiddenLayers: 1,
	...
	c.NumHiddenNodes[0] = 8
	c.Weights[0] = VarPartNNWeights32Layer0[:]
	c.Weights[1] = VarPartNNWeights32Layer1[:]
	c.Bias[0] = VarPartNNBias32Layer0[:]
	c.Bias[1] = VarPartNNBias32Layer1[:]
	return c
}()

// VarPartNNConfig16 mirrors vp9_var_part_nnconfig_16 (libvpx
// vp9/encoder/vp9_partition_models.h:720-735). FEATURES=6.
var VarPartNNConfig16 = func() NNConfig {
	c := NNConfig{
		NumInputs:       6,
		NumOutputs:      1,
		NumHiddenLayers: 1,
	...
	c.NumHiddenNodes[0] = 8
	c.Weights[0] = VarPartNNWeights16Layer0[:]
	c.Weights[1] = VarPartNNWeights16Layer1[:]
	c.Bias[0] = VarPartNNBias16Layer0[:]
	c.Bias[1] = VarPartNNBias16Layer1[:]
	return c
}()

// NNPredict is the verbatim port of nn_predict
...
// entries.
func NNPredict(features []float32, nnConfig *NNConfig, output []float32) {
	numInputNodes := nnConfig.NumInputs
	var buf [2][NNMaxNodesPerLayer]float32
	bufIndex := 0
	inputNodes := features
