...
// w8 path with H=16 (so the horizontal pass runs H+5=21 rows). Two
// passes:
//
...
//
// Identical encoding strategy to subpixel_8x8_arm64.s — just longer
// loop counts and a bigger tmp buffer (21*8 bytes).
//
