...
func TestVP8PickerSourceBufferParity(t *testing.T) {
	t.Run("BestARNRCohortGateClosed", testVP8PickerSourceBestARNRCohortGateClosed)
	t.Run("GoodARNRCohortGateClosed", testVP8PickerSourceGoodARNRCohortGateClosed)
	t.Run("PickerSourceSamplesAtMBOriginFrame1", testVP8PickerSourceSamplesAtMBOriginFrame1)
	t.Run("ApplyARNRFilterRejectsMaxFramesOne", testVP8PickerSourceARNRFilterRejectsMaxFramesOne)
}

func testVP8PickerSourceBestARNRCohortGateClosed(t *testing.T) {
	// Cohort config from vp8_kf_1280x720_ssim_best_arnr_parity_test.go.
...
func testVP8PickerSourceGoodARNRCohortGateClosed(t *testing.T) {
...
func testVP8PickerSourceSamplesAtMBOriginFrame1(t *testing.T) {
...
func testVP8PickerSourceARNRFilterRejectsMaxFramesOne(t *testing.T) {
