...
// TestVP8Task245ChangeConfigConsumerThreeStageResize pins libvpx
...
func TestVP8Task245ChangeConfigConsumerThreeStageResize(t *testing.T) {
	const (
...
// TestVP8Task245ChangeConfigConsumerRateModelUsesNewDims pins libvpx's
...
func TestVP8Task245ChangeConfigConsumerRateModelUsesNewDims(t *testing.T) {
	const (
		initW = 1280
		initH = 720
	)
...
// TestVP8Task245ChangeConfigConsumerSnapshotSurvivesUnrelatedSetters pins
...
func TestVP8Task245ChangeConfigConsumerSnapshotSurvivesUnrelatedSetters(t *testing.T) {
