...
// TestVP8Task300SPLITMVMotionSearchBoundsAudit pins task #300's audit of the
...
func TestVP8Task300SPLITMVMotionSearchBoundsAudit(t *testing.T) {
	t.Run("LibvpxMaxFullPelValMatchesConstant", testTask300LibvpxMaxFullPelVal)
	t.Run("BestModeUsesWideUMVBoundsForAllPartitions", testTask300BestModeWideUMV)
	t.Run("SpeedModePreservesIntersectionForNonBlock8x8", testTask300SpeedModeIntersected)
	t.Run("BoundsAtFrameOriginAsymmetric", testTask300BoundsFrameOrigin)
}

func testTask300LibvpxMaxFullPelVal(t *testing.T) {
...
func testTask300BestModeWideUMV(t *testing.T) {
...
func testTask300SpeedModeIntersected(t *testing.T) {
...
func testTask300BoundsFrameOrigin(t *testing.T) {
