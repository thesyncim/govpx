...
func externalEncoderTestDataLimit(t *testing.T) int {
	t.Helper()
	return nonNegativeEnvInt(t, "GOVPX_ENCODER_TEST_DATA_LIMIT", 0)
}

func externalEncoderTestFrameLimit(t *testing.T) int {
	t.Helper()
	limit := nonNegativeEnvInt(t, "GOVPX_ENCODER_TEST_DATA_FRAMES", 6)
	if limit == 0 {
...
func externalEncoderTestDataMinimum(t *testing.T) int {
	t.Helper()
	return nonNegativeEnvInt(t, "GOVPX_ENCODER_TEST_DATA_MIN", 0)
}
