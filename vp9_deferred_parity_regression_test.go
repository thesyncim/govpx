...
// the second-tier RD chain — see TestVP9DeferredSeedsRuntimeControlsParity
...
// covered by TestVP9DeferredSeedsRuntimeControlsParity as open-gap
...
// TestVP9DeferredSeedsRuntimeControlsParity is the sibling probe for the
...
//
// TestVP9DeferredSeedsRuntimeControlsParity is a diagnostic for open
...
func TestVP9DeferredSeedsRuntimeControlsParity(t *testing.T) {
	if os.Getenv("GOVPX_WITH_ORACLE") != "1" {
