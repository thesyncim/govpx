...
// TestVP8Task351MVRefProbsDynamicSentinel pins the audit conclusion of
...
// commentary at vp8_task343_rt_cpu8_mb_bisect_test.go:39-83).
//
...
func TestVP8Task351MVRefProbsDynamicSentinel(t *testing.T) {
	t.Run("ZeroMVCostMatchesLibvpxAcrossAllIntraCounts", testTask351ZeroMVCostMatchesLibvpxAcrossAllIntraCounts)
	t.Run("DynamicCountsDriveProbLookup", testTask351DynamicCountsDriveProbLookup)
	t.Run("Cell BCostGapTracesToCountsIntraDelta", testTask351CellBCostGapTracesToCountsIntraDelta)
}

// testTask351ZeroMVCostMatchesLibvpxAcrossAllIntraCounts confirms that for
...
func testTask351ZeroMVCostMatchesLibvpxAcrossAllIntraCounts(t *testing.T) {
...
// testTask351DynamicCountsDriveProbLookup confirms findNearInterMotionVectors
...
func testTask351DynamicCountsDriveProbLookup(t *testing.T) {
...
// testTask351CellBCostGapTracesToCountsIntraDelta reproduces the +293
...
func testTask351CellBCostGapTracesToCountsIntraDelta(t *testing.T) {
