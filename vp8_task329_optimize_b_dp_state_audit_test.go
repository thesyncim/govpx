...
// TestVP8Task329OptimizeBDPStateChromaDCOne audits the DP-state arrays
...
// directive).
func TestVP8Task329OptimizeBDPStateChromaDCOne(t *testing.T) {
...
// TestVP8Task329OptimizeBDPStateChromaSweep widens the audit across
...
func TestVP8Task329OptimizeBDPStateChromaSweep(t *testing.T) {
	const blockType = planeTypeUV
...
// TestVP8Task329OptimizeBDPStateAllPlanesSweep extends the audit
...
func TestVP8Task329OptimizeBDPStateAllPlanesSweep(t *testing.T) {
	probs := &vp8tables.DefaultCoefProbs
	dcq := func(qi int) int16 { return int16(vp8common.DCQuant(qi, 0)) }
	planes := []struct {
		name      string
