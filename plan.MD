...
- Full postprocess controls: deblock, demacroblock, add-noise, MFQE.
...
- Unified RD scoring with libvpx-style rate/distortion costs and Q-derived
  lambda.
- Full inter candidate sweep: NEARESTMV, NEARMV, ZEROMV, NEWMV, SPLITMV.
