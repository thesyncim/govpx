...
BYTE_PARITY_TESTS := Test(OracleEncoder(StreamByteParity|CopyReferenceFrameParity|QuantizerMetadataParity|ProductionRuntimeTransitions720p)|VP9Oracle(Threaded720pStrictByteParityUsesTileWriter|PinnedNewModeStrictByteParity|EncoderStreamByteParity(FrameFlagsMatrix|ControlCrossMatrix|LookaheadFlushBursts)|RuntimeControlConstantByteParityMatrix))
