...
func FuzzVP8MultiResSVCByteParity(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, data []byte) {
		c := vp8Task253FuzzCaseFromBytes(data)
		switch c.shape {
		case 0:
			runVP8Task253MultiResFuzzCase(t, c)
		case 1, 2:
			runVP8Task253SVCFuzzCase(t, c)
		}
	})
}

type vp8Task253FuzzCase struct {
	shape          int
	cpuUsed        int
...
func vp8Task253FuzzCaseFromBytes(data []byte) vp8Task253FuzzCase {
...
// runVP8Task253MultiResFuzzCase drives a 2-rendition VP8 simulcast
...
func runVP8Task253MultiResFuzzCase(t *testing.T, c vp8Task253FuzzCase) {
	...
	govStreams := vp8Task253MultiResStreams(t, parentW, parentH, fps, c.frames, deadline, cpuUsed, layers)
	...
	for i, l := range layers {
		...
		for fIdx := 0; fIdx < c.frames; fIdx++ {
			...
			sources[fIdx] = vp8Task253DownsampleI420(parent, l.Width, l.Height)
		}
...
// runVP8Task253SVCFuzzCase drives a 2- or 3-layer temporal SVC stream
...
func runVP8Task253SVCFuzzCase(t *testing.T, c vp8Task253FuzzCase) {
