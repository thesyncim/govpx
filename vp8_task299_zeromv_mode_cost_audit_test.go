...
// TestVP8Task299ZeroMVModeCostAuditSentinel pins the audit conclusion of task
...
func TestVP8Task299ZeroMVModeCostAuditSentinel(t *testing.T) {
	...
	t.Run("MBSplitTreeAndProbsMatchLibvpx", testTask299MBSplitTreeAndProbsMatchLibvpx)
	t.Run("SubMVRefTreeAndProbsMatchLibvpx", testTask299SubMVRefTreeAndProbsMatchLibvpx)
	t.Run("MBZeroZeroFrame1AllModeCostsMatchOracle", testTask299MBZeroZeroFrame1AllModeCostsMatchOracle)
	t.Run("PerModeCostMatchesVP8CostMVRefOracleAllContexts", testTask299PerModeCostMatchesVP8CostMVRefOracleAllContexts)
	t.Run("PartitionCostMatchesVP8CostTokenOracle", testTask299PartitionCostMatchesVP8CostTokenOracle)
	t.Run("SubMVRefCostMatchesInterBmodeCostsOracle", testTask299SubMVRefCostMatchesInterBmodeCostsOracle)
	t.Run("NearMVCountsAtFrameOriginAreZero", testTask299NearMVCountsAtFrameOriginAreZero)
}

func testTask299InterModeContextsMatchesLibvpx(t *testing.T) {
...
func testTask299MVRefTreeMatchesLibvpx(t *testing.T) {
...
func testTask299MBSplitTreeAndProbsMatchLibvpx(t *testing.T) {
...
func testTask299SubMVRefTreeAndProbsMatchLibvpx(t *testing.T) {
...
func testTask299MBZeroZeroFrame1AllModeCostsMatchOracle(t *testing.T) {
...
func testTask299PerModeCostMatchesVP8CostMVRefOracleAllContexts(t *testing.T) {
...
func testTask299PartitionCostMatchesVP8CostTokenOracle(t *testing.T) {
...
func testTask299SubMVRefCostMatchesInterBmodeCostsOracle(t *testing.T) {
...
func testTask299NearMVCountsAtFrameOriginAreZero(t *testing.T) {
