...
// TestVP8Task353Panning360pMBBisect performs per-MB localization of any
...
//	  go test -tags govpx_oracle_trace -run TestVP8Task353Panning360pMBBisect -v
func TestVP8Task353Panning360pMBBisect(t *testing.T) {
	...
	// task343MakePanningFrame in vp8_task343_rt_cpu8_mb_bisect_test.go,
