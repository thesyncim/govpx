...
// TestVP8KF1280x720SSIMBestARNRParity pins a high-resolution VP8 option mix
// that exercises the BestQuality keyframe picker, VBR rate control,
...
//
// The test checks packet sizes and first-partition sizes against a
// reproducible libvpx oracle run before logging short SHA prefixes. That keeps
// the assertion objective while leaving enough detail to diagnose future parity
// drift.
