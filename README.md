...
LAST/ZEROMV residual interframes, DCPred intra macroblocks inside interframes,
and libvpx-inspired full-pixel NEWMV interframes with last/golden/altref
reference selection, near-MV reuse, bounded diamond refinement, and reference
refresh control, invisible-frame handling, plus opt-in
