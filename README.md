...
Normal tests include small VP8/IVF smoke vectors, including a libvpx-authored
reference stream and a subpixel NEWMV stream, with expected checksums generated
by the libvpx v1.16.0 oracle. These run without libvpx installed.
...
prints JSON metrics for CI/local tracking.
