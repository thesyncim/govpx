...
The generated corpus asserts the intended profile, token-partition,
active eight-partition payload, and segmentation-map features before comparing
Decode and DecodeInto checksums against libvpx.
