...
- 2026-05-17 items 6 and 10 verified already implemented: golden-frame correction-factor lives in vp8_ratecontrol_postencode.go (usesGoldenFrameCorrectionFactor), recode-loop dampVar dispatch in vp8_ratecontrol_recode.go; VP8 version 1-3 dispatch lives in internal/vp8/decoder/version.go with all 4 call sites wired in vp8_decoder.go (IsSupportedVersion, LoopFilterHeaderForVersion, InterPredictionConfigForVersion, VersionSkipsLoopFilter).
