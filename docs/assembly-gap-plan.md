...
| P0 | FDCT4x4/8x8/WHT4x4 | amd64 | `internal/vp9/encoder/transform_quant_dispatch_amd64.go`, `internal/vp9/encoder/fdct4x4_amd64.s`, `internal/vp9/encoder/fwht_amd64.s`, future fdct8x8 asm | `vpx_dsp/x86/fdct_sse2.c`, `vp9/encoder/x86/vp9_dct_sse2.c` | FDCT4x4 and WHT4x4 use SSE2 with scalar fallback; FDCT8x8 remains scalar | `go test ./internal/vp9/encoder -run 'TestForward(DCT4x4|DCT8x8|WHT4x4)' -count=1`; direct SIMD-vs-scalar tests and benches |
