...
| P0 | Six-tap split predictors | amd64 | `internal/vp8/dsp/subpixel_amd64.go`, `subpixel_amd64.s` | `vp8/common/x86/subpixel_sse2.asm`, `vp8/common/x86/vp8_asm_stubs.c` | 16x16/8x16/8x8/8x4/4x4 SSE2 exist; 16x8 still composes two 8x8 calls on amd64 | `go test ./internal/vp8/dsp -run 'TestSixTapPredict.*|FuzzVP8DSPSubpixel' -count=1`; `go test ./internal/vp8/dsp -run '^$' -bench 'BenchmarkSixTapPredict(16x8|8x16)$' -benchmem -benchtime=500ms -count=5` on amd64 |
