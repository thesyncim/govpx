...
- [ ] Align key-frame and inter-intra pickers with libvpx RD code.
  ...
  - Missing: UV intra mode selection through transform/quantize/token-cost
    distortion instead of chroma SSE/rate approximations.
...
- [ ] Audit quantization and coefficient optimization against libvpx.
  ...
  - Missing: libvpx Viterbi trellis, `zbin_extra`, fast-vs-regular quantizer
    ...
    `check_reset_2nd_coeffs`, and token-cost trace anchors.
