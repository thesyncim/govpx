...
- Root VP8 files: 82 implementation files and 319 test files.
- Root VP9 files: 71 implementation/facade files and 220 test files.
...
- Test-name clusters:
  - Non-internal tests: 571.
  - Internal tests: 321.
  - Files with `oracle` in the name: 178.
  - Files with `parity` in the name: 90.
  - Files with `fuzz` in the name: 47.
  - Files with `bench` in the path: 28.
...
| 1236 | `vp9_encoder_config.go` |
| 1216 | `vp9_encoder_tile_workers.go` |
...
| 905 | `internal/vp9/encoder/cyclic_refresh.go` |
