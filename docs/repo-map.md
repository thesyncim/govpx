...
- Root VP9 files: 73 implementation/facade files and 241 test files.
...
- Keep true root facade/API tests in root: RTP facade, active maps, worker
  ...
  decryptor, external-frame-buffer, show-existing, frame-info, DecodeInto,
  corpus, and public encoder-to-decoder roundtrip facade coverage now runs from
  `package govpx_test`.
