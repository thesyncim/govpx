...
- Root VP8 files: 82 implementation files and 246 test files.
- Root VP9 files: 69 implementation/facade files and 169 test files.
...
| 1333 | `vp9_decoder_helpers_inter_motion_test.go` |
| 1317 | `vp8_encoder.go` |
| 1317 | `examples/webrtc-vp8/main.go` |
