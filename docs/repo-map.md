...
- Root Go files: 521.
- Root test files: 361.
- Internal Go files: 742.
- Root VP8 files: 82 implementation files and 214 test files.
- Root VP9 files: 69 implementation/facade files and 136 test files.
