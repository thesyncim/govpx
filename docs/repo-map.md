...
- Root VP9 files: 73 implementation/facade files and 249 test files.
...
- Keep true root facade/API tests in root: RTP facade, active maps, worker
  ...
  byte-alignment, header-rejection, postprocess/error-concealment, Row-MT and
  loop-filter-opt validation, malformed multi-tile-prefix rejection,
