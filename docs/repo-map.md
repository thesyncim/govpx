...
- Internal package files:
  ...
  - `internal/testutil`: 58 Go files.
- Test-name clusters:
  - Non-internal tests: 603.
  - Internal tests: 325.
  - Test files with `oracle` in the name: 190.
  - Test files with `parity` in the name: 92.
  - Files with `fuzz` in the name: 50.
