...
- Root Go files: 533.
- Root test files: 373.
- Internal Go files: 664.
- Root VP8 files: 80 implementation files and 219 test files.
...
helpers. Root tests may use coracle; production packages must not import it.
