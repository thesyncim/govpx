...
- Root VP8 files: 82 implementation files and 216 test files.
- Root VP9 files: 69 implementation/facade files and 137 test files.
...
- Test-name clusters:
  ...
  - Internal tests: 321.
  - Files with `oracle` in the name: 126.
  - Files with `parity` in the name: 76.
  - Files with `fuzz` in the name: 43.
