...
// TestTask242DropFrameRefundsAvPerFrameBandwidth pins libvpx
...
func TestTask242DropFrameRefundsAvPerFrameBandwidth(t *testing.T) {
	rc := rateControlState{
		mode:              RateControlCBR,
		bitsPerFrame:      8000,
...
// TestTask242DropFrameClampsToMaximumBufferSize pins the post-refund
...
func TestTask242DropFrameClampsToMaximumBufferSize(t *testing.T) {
	rc := rateControlState{
		mode:              RateControlCBR,
		bitsPerFrame:      8000,
...
// TestTask242DropFrameLeavesRateCorrectionFactorUntouched pins libvpx's
...
func TestTask242DropFrameLeavesRateCorrectionFactorUntouched(t *testing.T) {
	rc := rateControlState{
		mode:                 RateControlCBR,
		bitsPerFrame:         8000,
...
// TestTask242DropFrameLeavesTotalActualBitsUntouched pins libvpx's
...
func TestTask242DropFrameLeavesTotalActualBitsUntouched(t *testing.T) {
	rc := rateControlState{
		mode:              RateControlCBR,
		bitsPerFrame:      8000,
		bufferLevelBits:   -1000,
...
// TestTask242DropFrameAdvancesFramesSinceKey pins libvpx's
...
func TestTask242DropFrameAdvancesFramesSinceKey(t *testing.T) {
	rc := rateControlState{
		mode:                RateControlCBR,
		bitsPerFrame:        8000,
		bufferLevelBits:     -1000,
...
// TestTask242DropFrameRefusesWhenNotCBR pins libvpx's end_usage gate:
...
func TestTask242DropFrameRefusesWhenNotCBR(t *testing.T) {
...
// TestTask242DropFrameRefusesWhenDropFrameNotAllowed pins libvpx's
...
func TestTask242DropFrameRefusesWhenDropFrameNotAllowed(t *testing.T) {
	rc := rateControlState{
		mode:              RateControlCBR,
		bitsPerFrame:      8000,
		bufferLevelBits:   -1000,
...
// TestTask242TightBufferPFrameTargetUndershoot pins libvpx
...
func TestTask242TightBufferPFrameTargetUndershoot(t *testing.T) {
	rc := rateControlState{
		mode:              RateControlCBR,
		bitsPerFrame:      8000,
...
// TestTask242TightBufferPFrameTargetUndershootClampedByUnderShootPct
...
func TestTask242TightBufferPFrameTargetUndershootClampedByUnderShootPct(t *testing.T) {
	rc := rateControlState{
		mode:              RateControlCBR,
		bitsPerFrame:      8000,
...
// TestTask242DropFrameSequenceMatchesLibvpxCBR plays a 5-frame
...
func TestTask242DropFrameSequenceMatchesLibvpxCBR(t *testing.T) {
	rc := rateControlState{
		mode:              RateControlCBR,
		bitsPerFrame:      8000,
