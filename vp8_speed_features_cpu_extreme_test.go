...
// TestVP8SpeedFeaturesCPUExtremePinsLibvpxCascade pins the verbatim
...
func TestVP8SpeedFeaturesCPUExtremePinsLibvpxCascade(t *testing.T) {
	type want struct {
...
// TestVP8ExtremeCPUUsedHalfPixelStaysEnabled pins the libvpx
...
func TestVP8ExtremeCPUUsedHalfPixelStaysEnabled(t *testing.T) {
...
// TestVP8ExtremeCPUUsedThreshMapsTerminalEntries pins the
...
func TestVP8ExtremeCPUUsedThreshMapsTerminalEntries(t *testing.T) {
...
// TestVP8ExtremeCPUUsedSimpleLoopFilterStaysOff pins the libvpx
...
func TestVP8ExtremeCPUUsedSimpleLoopFilterStaysOff(t *testing.T) {
	for _, tc := range []struct {
		cpuUsed          int
...
// TestVP8ExtremeCPUUsedEncodesAcrossResolutions exercises the
...
func TestVP8ExtremeCPUUsedEncodesAcrossResolutions(t *testing.T) {
	resolutions := []struct {
		name   string
		width  int
		height int
